...
const PrescriptionMessageReport = async (mobileNumber, content, file) => {
    ...
    try {
        ...
        const options = {
            ...
            data: {
                ...
                template: {
                    name: "prescription_upload_message",
                    languageCode: "en_US",
                    headerValues: [
                        file
                    ],
                    fileName: `${content?.name}-prescription.pdf`,
                    bodyValues: [
                        content?.name,
                        content?.name
                    ]
...
module.exports = PrescriptionMessageReport;
