...
export default function Vaccination() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                const res = await axios.get('http://192.168.1.26:1337/api/collection-types?populate=*');
                const fetchSliderData = await axios.get('http://192.168.1.26:1337/api/bakery-sliders?populate=*&filters[isVacination][$eq]=true');
