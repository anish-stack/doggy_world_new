...
const AllBakeryProducts = () => {
    ...
    const fetchProducts = async () => {
        setLoading(true)
        try {
            const response = await axios.get("http://localhost:8000/api/v1/get-bakery-product")
    ...
    const fetchCategories = async () => {
        try {
            const response = await axios.get("http://localhost:8000/api/v1/get-all-pet-bakery")
    ...
    const handleCreateProduct = () => {
        router("/dashboard/create-and-edit-pet-bakery-categories")
    }

    // Navigate to edit product page
    const handleEditProduct = (productId) => {
        router(`/dashboard/create-and-edit-pet-bakery-categories?id=${productId}`)
    }
    ...
    const handleDeleteProduct = async (productId) => {
        try {
            ...
            await axios.delete(`http://localhost:8000/api/v1/delete-bakery-product/${productId}`)
        ...
        <div className="container mx-auto p-4 space-y-6">
            <Card>
                <CardHeader className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <CardTitle className="text-2xl font-bold">Pet Bakery Products</CardTitle>
                        <CardDescription>
                            Manage your pet bakery product catalog
                        </CardDescription>
                    </div>
...
export default AllBakeryProducts
