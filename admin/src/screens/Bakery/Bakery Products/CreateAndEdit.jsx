...
const CreateAndEdit = () => {
    ...
    const fetchProductDetails = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`http://localhost:8000/api/v1/get-bakery-product/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let response;
            if (isEditMode) {
                response = await axios.post(`http://localhost:8000/api/v1/update-bakery-product/${id}`, formDataToSend, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                });
            } else {
                response = await axios.post('http://localhost:8000/api/v1/create-pet-bakery-product', formDataToSend, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                });
            ...
            window.location.href = '/dashboard/pet-bakery-products';
        } catch (error) {
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction onClick={() => window.location.href = '/admin/products'}>
                                        Yes, discard changes
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
