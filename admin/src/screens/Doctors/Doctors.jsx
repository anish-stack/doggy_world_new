...
import EditAndCreateDoctorModel from './EditAndCreateDoctor'
...
const Doctors = () => {
    ...
    const handleDeleteDesign = async () => {
        try {
            ...
            const response = await axios.delete(`${API_URL}/doctors/delete/${setSelectedDoctor._id}`);
        ...
        <div className="container mx-auto py-6">
            <Card className="w-full">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-2xl font-bold">Home Doctor</CardTitle>
                    <Button
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <TableHead className="w-24 text-center">Doctor</TableHead>
                                            ...
                                            paginatedData.map((doctor) => (
                                                <TableRow key={doctor._id}>
                                                    ...
                                                    <TableCell className="text-center">
                                                        {doctor.imageUrl && doctor.imageUrl.url ? (
                                                            <img
                                                                src={doctor.imageUrl.url}
                                                                alt={doctor.name}
                                                                onError={(e) => {
                                                                    e.target.onerror = null;
                                                                    e.target.src = "https://i.ibb.co/KcP7PWKZ/images.png";
                                                                }}
                                                                className="h-12 w-12 object-cover rounded-md mx-auto"
                                                            />
                                                        ) : (
                                                            <img
                                                                src="https://i.ibb.co/KcP7PWKZ/images.png"
                                                                alt="Default Image"
                                                                className="h-12 w-12 object-cover rounded-md mx-auto"
                                                            />
                                                        )}
                                                    ...
                                                    <TableCell className="text-center">
                                                        <span
                                                            className={`px-2 py-1 rounded-full text-xs font-medium ${doctor.is_best
                                                                ? 'bg-green-100 text-green-800'
                                                                : 'bg-red-100 text-red-800'
                                                                }`}
                                                        >
                                                            {doctor.is_best ? 'Best' : 'Normal'}
                                                        </span>
                                                    </TableCell>
                                                    <TableCell>
            ...
            <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will permanently delete the flavor "{selectedDoctor?.name}".
