...
const AllFlavours = () => {
  ...
  const handleDeleteDesign = async () => {
    try {
      ...
      const response = await axios.delete(`${API_URL}/cake-flavour/${selectedDesign._id}`);
    ...
    <div className="container mx-auto py-6">
      <Card className="w-full">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-2xl font-bold">Cake Flavors</CardTitle>
          <Button 
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead  className="w-16 text-start">Flavor Name</TableHead>
